...
function AnimateQuote() {
  ...
  return (
    <div className="mx-2 xs:mx-7 sm:mx-10 md:mx-16 lg:mx-24 xl:mx-40 w-1/3 section-gap">
      <div ref={ref} className={`animated-div-1 ${inView ? 'slide-in' : ''} py-40 relative text-center bg-slate-700 rounded-xl`}>
